        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenDA = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CongViec_NguoiDung_IdNguoiDung",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CongViec_IdNguoiDung",
                table: "CongViec",
                column: "IdNguoiDung",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NguoiDung_DuAnId",
                table: "NguoiDung",
                column: "DuAnId");
        }
